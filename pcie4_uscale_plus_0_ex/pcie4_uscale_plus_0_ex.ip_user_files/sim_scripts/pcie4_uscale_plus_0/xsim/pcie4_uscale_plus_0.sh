...
export RDI_DATADIR="/home/mark/software/amd/installed/Vivado/2024.2/data"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L gtwizard_ultrascale_v1_7_19 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot pcie4_uscale_plus_0 xil_defaultlib.pcie4_uscale_plus_0 xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/mark/software/amd/installed/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb pcie4_uscale_plus_0.wdb xsim.dir libdpi.so)
